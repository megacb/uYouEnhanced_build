...
- For AltStore user: 
  ...
  - [Open in AltStore (v19.07.5-3.0.3)](http://tinyurl.com/3rmw28by) - It will take a while to install because AltStore needs to download the IPA first.
